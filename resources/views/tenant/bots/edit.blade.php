    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('tenant.bots.update', $bot) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="description" 
                                              id="description" 
                                              rows="3"
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-500 @enderror">{{ old('description', $bot->description) }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" 
                                           name="phone_number" 
                                           id="phone_number" 
                                           value="{{ old('phone_number', $bot->phone_number) }}"
                                           required
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Formato internacional</p>
                                    @error('phone_number')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="language" 
                                        ...
                                        <option value="pt" {{ old('language', $bot->language) === 'pt' ? 'selected' : '' }}>Português</option>
                                        ...
                                        <option value="it" {{ old('language', $bot->language) === 'it' ? 'selected' : '' }}>Italiano</option>
                                    </select>
                                    @error('language')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="ai_model" 
                                        ...
                                        <option value="gpt-4" {{ old('ai_model', $bot->ai_model) === 'gpt-4' ? 'selected' : '' }}>GPT-4 (Recomendado)</option>
                                        <option value="gpt-4-turbo" {{ old('ai_model', $bot->ai_model) === 'gpt-4-turbo' ? 'selected' : '' }}>GPT-4 Turbo (Más rápido)</option>
                                        <option value="gpt-3.5-turbo" {{ old('ai_model', $bot->ai_model) === 'gpt-3.5-turbo' ? 'selected' : '' }}>GPT-3.5 Turbo (Económico)</option>
                                    </select>
                                    @error('ai_model')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">0.0 = Preciso, 2.0 = Creativo</p>
                                    @error('temperature')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                {{-- Tokens máximos --}}
                                <div>
                                    <label for="max_tokens" class="block text-sm font-medium text-gray-700 mb-1">
                                    ...
                                    <input type="number" 
                                           ...
                                           min="50"
                                           max="4000"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('max_tokens') border-red-500 @enderror">
                                    <p class="mt-1 text-xs text-gray-500">Recomendado: 500-1000</p>
                                    @error('max_tokens')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    <label for="inactivity_timeout_minutes" class="block text-sm font-medium text-gray-700 mb-1">
                                        Timeout de Inactividad (minutos)
                                    </label>
                                    <input type="number" 
                                           name="inactivity_timeout_minutes" 
                                           id="inactivity_timeout_minutes" 
                                           value="{{ old('inactivity_timeout_minutes', $bot->inactivity_timeout_minutes) }}"
                                           min="5"
                                           max="1440"
                                           class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('inactivity_timeout_minutes') border-red-500 @enderror">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="personality" 
                                              id="personality" 
                                              rows="3"
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('personality') border-red-500 @enderror">{{ old('personality', $bot->personality) }}</textarea>
                                    @error('personality')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="instructions" 
                                              id="instructions" 
                                              rows="4"
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('instructions') border-red-500 @enderror">{{ old('instructions', $bot->instructions) }}</textarea>
                                    @error('instructions')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="time" 
                                           ...
                                           value="{{ old('business_hours_start', substr($bot->business_hours_start, 0, 5)) }}"
                                ...
                                <div>
                                    ...
                                    <input type="time" 
                                           ...
                                           value="{{ old('business_hours_end', substr($bot->business_hours_end, 0, 5)) }}"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        @php
                                            ...
                                            $selectedDays = old('business_days', $bot->business_days ?? []);
                                        @endphp
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="out_of_hours_message" 
                                              ...
                                              rows="2"
                                              class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('out_of_hours_message') border-red-500 @enderror">{{ old('out_of_hours_message', $bot->out_of_hours_message) }}</textarea>
                                ...
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input type="checkbox" 
                                               ...
                                               value="1"
                                               {{ old('fallback_to_human', $bot->fallback_to_human) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    </div>
                                    <div class="ml-3 text-sm">
                                ...
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input type="checkbox" 
                                               ...
                                               value="1"
                                               {{ old('use_knowledge_base', $bot->use_knowledge_base) ? 'checked' : '' }}
                                               class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    </div>
                                    <div class="ml-3 text-sm">
                                        <label for="use_knowledge_base" class="font-medium text-gray-700">Usar Base de Conocimiento (RAG)</label>
                                        <p class="text-gray-500">El bot usará documentos cargados para responder</p>
                                    </div>
                                </div>
                            </div>
                        </div>
